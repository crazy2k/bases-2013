...
\vspace*{0.5cm}
\noindent
Encuesta(\underline{\dotuline{id\_user}, id\_encuesta},
...
\vspace*{0.5cm}
\noindent
DatosPersonales(\underline{\dotuline{id\_user}, nombre, apellido},
...
\vspace*{0.5cm}
\noindent
Hace(\underline{\dotuline{nro\_reserva, id\_user}})
\begin{itemize}
...
\vspace*{0.5cm}
\noindent
Tiene(\underline{\dotuline{nro\_reserva, id\_servicio, id\_clase}})
\begin{itemize}
...
\vspace*{0.5cm}
\noindent
Brinda(\underline{\dotuline{id\_servicio, id\_clase}}, precio)
\begin{itemize}
...
\vspace*{0.5cm}
\noindent
Clase(\underline{\dotuline{nro\_reserva, id\_user}})
\begin{itemize}
	\item $FK = \{nro\_reserva, id\_user\}$
	\item $PK = CK = \{(nro\_reserva, id\_user)\}$
	\item $Hace.nro\_reserva$ debe estar en $Reserva.nro\_reserva$
...
\vspace*{0.5cm}
\noindent
SeDistribuyenEn(\underline{\dotuline{modelo, id\_clase}},
	cantidad\_asientos)
\begin{itemize}
